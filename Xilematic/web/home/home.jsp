  ...
  <header>
        <div class="header-logo">
            ...
            <div class="navbar">
                ...
                <a href="#">News</a>
                <a href="${pageContext.request.contextPath}/bookingServlet">Booking</a>
            </div>
        </div>
        ...
        <c:forEach var="movie" items="${nowShowingMovies}" varStatus="status">
            <li>
                ...
                <div class="layer_hover">
                    <a href="${pageContext.request.contextPath}/bookingServlet?id=${movie.id}" class="btn_reserve">Đặt vé nek</a>
